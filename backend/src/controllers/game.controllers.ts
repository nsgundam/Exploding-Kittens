 ...
 * FR-05-FV, S3-01
 */
export const favorCard = asyncHandler(async (req: Request, res: Response) => {
  const roomId = req.params.roomId as string;
  const playerToken = req.playerToken!;
 ...
 * FR-05-FV, S3-02
 */
export const favorResponse = asyncHandler(async (req: Request, res: Response) => {
  const roomId = req.params.roomId as string;
  const playerToken = req.playerToken!;
 ...
 * FR-05-N, S3-04
 */
export const nopeCard = asyncHandler(async (req: Request, res: Response) => {
  const roomId = req.params.roomId as string;
  const playerToken = req.playerToken!;
 ...
 */
export const comboCard = asyncHandler(async (req: Request, res: Response) => {
  const roomId = req.params.roomId as string;
  const playerToken = req.playerToken!;
